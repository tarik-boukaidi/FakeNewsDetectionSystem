...
import { Icon } from './Icon'; // wrapper pour TypeScript
    ...
    <header className="header">
      ...
      <nav>
        <ul>
          ...
          <li>
            <Link to="/analyse">
              <Icon as={FaChartBar} className="nav-icon" /> Analyse
            </Link>
          </li>
          <li>
            <Link to="/a-propos">
              <Icon as={FaInfoCircle} className="nav-icon" /> À propos
            </Link>
          </li>
          <li>
            <Link to="/contact">
              <Icon as={FaEnvelope} className="nav-icon" /> Contact
            </Link>
          </li>
        </ul>
      </nav>
