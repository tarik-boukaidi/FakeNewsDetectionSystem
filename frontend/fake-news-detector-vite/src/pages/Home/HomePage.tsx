...
import Hero from '../../components/Hero/Hero'; /* Nous garderons le Hero de la première capture d'écran ici */
import ServicesSection from '../../components/ServicesSection/ServicesSection'; // Import du nouveau composant
import FeaturesSection from '../../components/FeaturesSection/FeaturesSection';
import CallToAction from '../../components/CallToAction/CallToAction';
import Footer from '../../components/Footer/Footer';
import AnimatedSection from '../../components/AnimatedSection/AnimatedSection';// Import du composant d'animation
